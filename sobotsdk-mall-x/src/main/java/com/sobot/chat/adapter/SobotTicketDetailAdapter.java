...
public class SobotTicketDetailAdapter extends SobotBaseAdapter<Object> {
    ...
    private static final String[] layoutRes = {
            "sobot_ticket_detail_head_item",//详情头布局xxxx
...
//                        imageView.setImageResource(ResourceUtils.getDrawableId(mContext,"sobot_icon_arrow_dwon"));
            ...
            if (otherGroup != null) {
                ...
                recyclerView.addItemDecoration(new SpaceItemDecoration(ScreenUtils.dip2px(mContext, 10), ScreenUtils.dip2px(mContext, 10)));
        ...
        void bindData(Object item, int position) {
            int color = ResourceUtils.getResColorValue(context, "sobot_color_evaluate_text_btn");
    ...
    class Type1ViewHolder extends BaseViewHolder {
        ...
        void bindData(Object item, int position) {
            if (position == 1) {
                ...
                sobot_tv_icon.setSelected(false);
        ...
        void bindData(Object item, int position) {
            ...
            if (reply != null) {
                if (reply.getStartType() == 0) {
                    ...
                    sobot_tv_description.setText(ResourceUtils.getResString(context, "customer_service_reply"));
                    ...
                    sobot_tv_description.setText(ResourceUtils.getResString(context, "sobot_my_reply"));
    ...
    class Type3ViewHolder extends BaseViewHolder implements View.OnClickListener {
        ...
        void bindData(Object item, int position) {
            ...
            if (TextUtils.isEmpty(data.getContent())) {
                ...
                HtmlTools.getInstance(context).setRichText(sobot_tv_content, data.getContent().replaceAll("\n", "<br/>").replaceAll("<img.*?/>", ResourceUtils.getResString(context, "sobot_chat_type_pic")), getLinkTextColor());
            }
